...
import { ArrowDownCircle, BanIcon, CheckCircle, Clock, CoinsIcon, Divide, DollarSign, Edit, EditIcon, Eye, EyeIcon, EyeOffIcon, LockIcon, Plus, PlusIcon, StarIcon, TrashIcon, TrendingUp, Users, WalletIcon, XCircle } from 'lucide-react'
...
const MyListing = () => {
  ...
  return (
    <div  className="px-4 md:px-8 lg:px-12 xl:px-20 py-6">
  ...
  <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
    ...
    <StatCard title='Active listings' value={userListings.length} icon={<CheckCircle className='size-6 text-green-600'/>} color='green' />
    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 xl:gap-20 p-6 mb-10 bg-white rounded-xl border border-gray-200'>
      {[
        ...
        {label: 'Withdrawn', value: balance.withdrawn, icon:ArrowDownCircle},
  ...
  (
    <div className='bg-white rounded-lg border border-gray-200 p-16 text-center'>
      <div className='w-16 h-16 bg-gary-100 rounded-full flex items-center justify-center mx-auto mb-4'>
        <PlusIcon className='w-8 h-8 text-gray-400'/>
      </div>
      <h3 className='text-xl font-medium text-gary-800 mb-2'>No listings yet</h3>
              ...
              <div className='flex-1 '>
                <div className='flex justify-between items-start'>
                  ...
                  <div className='flex items-center gap-2'>
                    <div className='relative group'> <LockIcon size={14} />
                    <div className='invisible group-hover:visible absolute right-0 top-0 pt-4.5 z-10'>
                      <div className='bg-white text-gray-600 text-xs rounded border border-gray-600 text-xs rounded border border-gray-200 p-2 px-3'>
                    ...
                    ( <StarIcon
                      onClick={()=>markAsFeatured(listing.id)} size={18} className= {`text-yellow-500 cursor-pointer ${listing.featured && "fill-yellow-500" }`}/>
                  )}
                  </div>
                </div>

import {  CheckCircle2, ChevronUp, Copy, CopyCheckIcon, CopyIcon, Loader2Icon } from 'lucide-react';
          ...
          return (
            <div key={id} className='bg-white rounded-lg border border-gray-200 p-5 flex flex-col max-w-4xl'>
              ...
              <div className='flex flex-col gap-2 items-end'>
                <button onClick={() => setExpanded((p) => (p === id ? null : id))} className='flex items-center gap-2 bg-white border border-gray-200 px-3 py-2 rounded hover:shadow text-sm'

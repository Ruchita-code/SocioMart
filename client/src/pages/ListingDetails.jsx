...
import { ArrowLeftIcon,ChevronRightIcon, ArrowUpRightFromSquareIcon, CheckCircle2, ChevronLeftIcon, DollarSign, Loader2Icon, Users, LineChart, EyeIcon, Calendar, MapPin, MessageSquareMoreIcon, ShoppingBagIcon } from 'lucide-react';
    ...
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex items-start max-md:flex-col gap-10'> 
        <div className='flex-1 max-md:w-full'>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <div className='flex gap-2 mt-2'>
                  {listing.verified && (
                    <span className='flex-center text-xs bg-indigo-50 text-indigo-600 px-2 py-1 rounded-md'>
                      <CheckCircle2  className='w-3 h-3 mr-1 '/> verified
                    </span>
                  )}
                  {listing.monetized && (
                    <span className='flex-center text-xs bg-green-50 text-green-600 px-2 py-1 rounded-md'>
          ...
          {images?.length> 0 && ( <>
            <div className='bg-white rounded-xl border border-gray-200 mb-5 overflow-hidden'>
              <div className='p-4'><h4 className='font-semibold text-gray-800'>Screenshots & proof</h4></div>
            </div>
            {/* Slider container */}
        ...
        <div className='bg-white rounded-xl border border-gray-200 mb-5'>
         ...
         <div className='bg-white rounded-xl border border-gray-200 mb-5'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 p-4 gap-4 text-sm'>
            <div>
            ...
            <div>
              ...
              <p className='font-medium '>{listing.monetized  ?"Enable":"Disable"}</p>
            </div>

            <div>
              <p className='text-gray-500'>Status</p>
              <p className='font-medium capitalize'>{listing.status ?"Yes":"No"}</p>
            </div>
          </div>
         </div>
         </div>
        {/* Seller Info & purchase Option */}
        <div className='bg-white min-w-full md:min-w-[370px] rounded-xl border-gray-200 p-5 max-md:mb-10'>
          ...
          {listing.isCredentialChanged && (
            <button onClick={purchaseAccount} className='w-full mt-2 bg-purple-600 text-white py-white rounded-lg hover:bg-purple-700 transition text-sm font-medium flex items-center justify-center gap-2'>
      ...
      <div className='bg-white border-t border-gray-200 p-4 text-center mt-28'>
        <p className='text-sm text-gray-500'>
          @2026 <span className='text-indigo-600'>SocioMart</span>. All rights reserved.
        </p>

...
const FilterSlidebar = ({showFilterPhone, setShowFilterPhone ,filters, setFilters}) => { 
    ...
    const niche =[
        ...
        { value: "education", label: "Educatiion"},
            ...
            <div>
                ...
                {expandedSections.price && (
                    <div className='space-y-3'>
                        ...
                        {filters.maxPrice || 100000} onChange={(e) => onfilterChange({...filters,maxPrice: parseInt(e.target.value)})} className='w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-indigo-600'/>
                ...
                {expandedSections.followers && (
                    ...
                    onChange={(e) => onfilterChange({...filters,minFollowers: parseInt(e.target.value) || 0})}
                     className='w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-700 outline-indigo-500'>
                        ...
                        <option value="500000">10k+</option>
            ...
            <div>
                ...
                {expandedSections.niche && (
                    ...
                    className='w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-700 outline-indigo-500'>
                        ...
                        {niche.map((niche) =>( 
                            <option key={niche.value} value={niche.value}>{niche.value}</option>
                        ))}

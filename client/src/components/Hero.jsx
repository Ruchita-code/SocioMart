...
const Hero = () => {
  ...
  return (
    <>    
            <div className="min-h-screen flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
                ...
                <p className="max-w-xl text-center text-base my-7">A trusted marketplace to securely buy and sell Instagram, YouTube, Twitter, Telegram, and other social media accounts — fast, safe, and hassle-free.</p>
